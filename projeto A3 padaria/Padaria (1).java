        ...
        do {
            ...
            switch (opcao) {
                ...
                case 1:
                    ...
                    clientes[qtdClientes] = new Cliente(nome, idade, endereco, telefone);
                    qtdClientes++;
                ...
                case 2:
                    ...
                    ler.nextLine();
                    if(salario <1620){
                        System.out.println("não é permitido um valor abaixo do salário minímo");
                    }else{
                    funcionarios[qtdFuncionarios] = new Funcionario(nomeFunc, idadeFunc, cargo, salario);
                    qtdFuncionarios++;
                ...
                case 3:
                    ...
                    if(precoProduto <=0){
                        System.out.println("preço do produto invalido!");
                    }else{

                    produtos[qtdProdutos] = new Produto(nomeProduto, precoProduto);
                    qtdProdutos++;
                ...
                case 7:
                    ...
                    do {
                        ...
                        if (pedido >= 0 && pedido < qtdProdutos) {
                            total += produtos[pedido].getPreco();
                            System.out.println(produtos[pedido].getNome() + " adicionado ao pedido!");
                        } else if (pedido != -1) {
